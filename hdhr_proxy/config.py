...
DEFAULT_CONFIG = {
    ...
    "xmltv_url": None,
    "guide_reviews": True,
    "generate_guide_reviews": True,
    "guide_review_provider": "tvmaze",
    "guide_review_api_key": None,
    "guide_review_cache_file": "guide_reviews.cache.json",
    "mxf_file": "guide.mxf",
